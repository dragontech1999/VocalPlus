...
class VocalPlusLookAndFeel : public juce::LookAndFeel_V4
{
public:
    static inline const juce::Colour kBackground     { 0xff14161c };
    static inline const juce::Colour kPanel          { 0xff1c1f28 };
    static inline const juce::Colour kPanelBorder    { 0xff2a2f3a };
    static inline const juce::Colour kTextPrimary    { 0xffe8eaef };
    static inline const juce::Colour kTextSecondary  { 0xff8b919e };
    static inline const juce::Colour kAccent         { 0xff6b8afd };
    static inline const juce::Colour kAccentSoft     { 0xff4a5568 };
    static inline const juce::Colour kKnobTrack      { 0xff2e3340 };
    static inline const juce::Colour kKnobFill       { 0xff6b8afd };

    VocalPlusLookAndFeel()
    {
        ...
        setColour (juce::ToggleButton::tickDisabledColourId, kAccentSoft);
    }

    juce::Font getLabelFont (juce::Label&) override
    {
        return juce::FontOptions (11.5f);
    }
    ...
    {
        return juce::FontOptions (12.0f).withStyle ("Medium");
    }
                           ...
                           juce::Slider& slider) override
    {
        ...
        g.setColour (slider.isEnabled() ? kKnobFill : kAccentSoft);
